...
signal = function () {
  ...
  // signals can add / mult / elementSize themselves
  /**
...
oscillator = function () {
  ...
  // ========================== //
  // return sigChain(this, elementSize, thisChain, nextChain, Scale);
   ...
   *  again will override the initial elementSize() with new values.
   *  
   *  @method  elementSize
   *  @param  {Number} inMin  input range minumum
   *  @param  {Number} inMax  input range maximum
...
env = function () {
   ...
   *  @param {Number} [susRatio]    Ratio between attackLevel and releaseLevel, on a elementSize from 0 to 1,
